...
==== Which `Drug`s are reported the most by consumers?
...
==== What `Drug`s have the most side effects (`MedDraTerm`)?
...
==== What top ten `Drug` combinations have the most side effects (`MedDraTerm`) when administered together?
