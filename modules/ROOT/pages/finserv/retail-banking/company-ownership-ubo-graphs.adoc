...
image::https://github.com/erikbijl/neo4j-company-house-demo/blob/main/images/subsidiaries.png[Company hierarchy structure]
...
```
image::https://github.com/erikbijl/neo4j-company-house-demo/blob/main/images/data_model.png[The Database schema]
...
RETURN DISTINCT p
```
image::https://github.com/erikbijl/neo4j-company-house-demo/blob/main/images/subsidiaries.png[Company Structure]
...
RETURN p
```
image::https://github.com/erikbijl/neo4j-company-house-demo/blob/main/images/circular_ownership.png[Circular Ownership Structure]
...
```
image::https://github.com/erikbijl/neo4j-company-house-demo/blob/main/images/corporate_group.png[Corporate Group]
...
image::https://github.com/erikbijl/neo4j-company-house-demo/blob/main/images/bloom.png[Neo4j Bloom Visualization]
...
image::https://github.com/erikbijl/neo4j-company-house-demo/blob/main/images/dashboard.png[Neo4j Dashboards]
