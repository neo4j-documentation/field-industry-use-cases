...
* [The Companies data product](https://download.companieshouse.gov.uk/en_output.html)
* [The People with Significant Control (PSC) snapshot](https://download.companieshouse.gov.uk/en_pscdata.html)
...
Using the [apoc.path.expand](https://neo4j.com/docs/apoc/current/overview/apoc.path/apoc.path.expand/) function we can find the corporate groups of all related companies. This can result in big groups of related companies. 
