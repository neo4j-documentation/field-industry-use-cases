...
image::https://raw.githubusercontent.com/pedroleitao-neo4j/finance-churn/main/customer-churn.png[Customer Churn Overview]

== The Challenge

Customer Churn (customer attrition) refers to the phenomenon where customers stop doing business with a company. In the context of finance and retail banking, acquiring a new customer is significantly more expensive than retaining an existing one, making churn prediction a critical imperative.
